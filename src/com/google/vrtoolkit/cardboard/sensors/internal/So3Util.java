...
public class So3Util {
	...
	private static void rotationPiAboutAxis(Vector3d v, Matrix3x3d result) {
		...
		rotationPiAboutAxisTemp
				.scale(3.1415926535897931D / rotationPiAboutAxisTemp.length());
	...
	public static void muFromSO3(Matrix3x3d so3, Vector3d result) {
		...
		result.set((so3.get(2, 1) - so3.get(1, 2)) / 2D,
				(so3.get(0, 2) - so3.get(2, 0)) / 2D,
				(so3.get(1, 0) - so3.get(0, 1)) / 2D);
		...
		if (cosAngle > M_SQRT1_2) {
			...
			if (d0 * d0 > d1 * d1 && d0 * d0 > d2 * d2)
				r2.set(d0, (so3.get(1, 0) + so3.get(0, 1)) / 2D,
						(so3.get(0, 2) + so3.get(2, 0)) / 2D);
			else if (d1 * d1 > d2 * d2)
				r2.set((so3.get(1, 0) + so3.get(0, 1)) / 2D, d1,
						(so3.get(2, 1) + so3.get(1, 2)) / 2D);
			else
				r2.set((so3.get(0, 2) + so3.get(2, 0)) / 2D,
						(so3.get(2, 1) + so3.get(1, 2)) / 2D, d2);
