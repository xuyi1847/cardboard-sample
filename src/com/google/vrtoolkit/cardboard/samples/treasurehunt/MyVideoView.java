...
//			listView.setBackgroundColor(Color.GRAY);
	...
	public class CustomSimpleAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (position == 0) {
				ImageAdaptervideo adapter;
		    	adapter = new ImageAdaptervideo(mcontext);
...
//							Log.d("log",""+position1);
						...
						if (position1 == 0) {
							setBackground(R.drawable.bg_video_airfight);
						}
						if (position1 == 1) {
							setBackground(R.drawable.bg_video_dragon);
						}
						if (position1 == 2) {
							setBackground(R.drawable.bg_video_global);
						}
						if (position1 == 3) {
							setBackground(R.drawable.bg_video_hiphop);
						}
						if (position1 == 4) {
							setBackground(R.drawable.bg_video_house);
						}
						if (position1 == 5) {
							setBackground(R.drawable.bg_video_nemo);
						}
						if (position1 == 6) {
							setBackground(R.drawable.bg_video_sea);
						}
						if (position1 == 7) {
							setBackground(R.drawable.bg_video_superjunior);
						}
						if (position1 == 8) {
							setBackground(R.drawable.bg_video_topgirl);
						}
						if (position1 == 9) {
							setBackground(R.drawable.bg_video_wow);
						}
					}
...
//			                intent.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video_dragon.mp4"), "video/mp4");
//			                mcontext.startActivity(intent);
//						}
//						if(position==1)
//						{
//							Intent intent = new Intent(Intent.ACTION_VIEW);
//			                intent.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video_Global.mp4"), "video/mp4");
//			                mcontext.startActivity(intent);
//						}
//						if(position==2)
//						{
//							Intent intent = new Intent(Intent.ACTION_VIEW);
//			                intent.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video_SEA.mp4"), "video/mp4");
//			                mcontext.startActivity(intent);
//						}
//						if(position==3)
//						{
//							Intent intent = new Intent(Intent.ACTION_VIEW);
//			                intent.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video_TOPGIRL.mp4"), "video/mp4");
//			                mcontext.startActivity(intent);
//						}
					}
				});
