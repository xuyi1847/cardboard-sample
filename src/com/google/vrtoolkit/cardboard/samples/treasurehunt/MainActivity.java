    ...
    class BatteryReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(Intent.ACTION_BATTERY_CHANGED.equals(intent.getAction())){
				...
				if(i>0&&i<=20)
				{mOverlayView.setbutteryimage(R.drawable.icon_bettery_20);}
				if(i>20&&i<=40)
				{mOverlayView.setbutteryimage(R.drawable.icon_bettery_40);}
				if(i>40&&i<=60)
				{mOverlayView.setbutteryimage(R.drawable.icon_bettery_60);}
				if(i>60&&i<=80)
				{mOverlayView.setbutteryimage(R.drawable.icon_bettery_80);}
				if(i>80&&i<=100)
				{mOverlayView.setbutteryimage(R.drawable.icon_bettery_full);}
				
			}
		}
		
	}
    public void checksystemvolum(){
    	AudioManager mAudioManager = (AudioManager) getSystemService(Context.AUDIO_SERVICE);
    	int current = mAudioManager.getStreamVolume( AudioManager.STREAM_SYSTEM ); 
    	if(current==0)
    	{
    		mOverlayView.setvolumimage(R.drawable.icon_sound_off);
    	}
    	else
    	{
    		mOverlayView.setvolumimage(R.drawable.icon_sound_on);
    	}
    }
    public void checkbluetooth() {
    	BluetoothAdapter mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
    	if (!mBluetoothAdapter.isEnabled())
    	{mOverlayView.setbluetoothimage(R.drawable.icon_bluetooth_off);}
    	else
    	{mOverlayView.setbluetoothimage(R.drawable.icon_bluetooth_on);}
    }
...
//	                            .show();
	                	...
	                	mOverlayView.setwifiimage(R.drawable.icon_wifi_hig);
	                    break;  
	                case 2:  
	                ...
	                case 3:  
	                   // wifi_image.setImageResource(R.drawable.single2);  
	                	mOverlayView.setwifiimage(R.drawable.icon_wifi_mid);
	                    break;  
	                case 4:  
	                   // wifi_image.setImageResource(R.drawable.single1);  
	                	mOverlayView.setwifiimage(R.drawable.icon_wifi_low);
	                    break;  
	                case 5:  
	                  // wifi_image.setImageResource(R.drawable.single0);  
	                	mOverlayView.setwifiimage(R.drawable.icon_wifi_off); 
	                    break;  
	                default:  
	                    //以防万一  
	                   // wifi_image.setImageResource(R.drawable.single0);  
    ...
    public boolean onKeyDown(int keyCode, KeyEvent msg) {
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
        	CardboardOverlayView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
					null);
        	CardboardOverlayView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
					null);
        	if(position!=1)
        	{position=position-1;}
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
        	CardboardOverlayView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
					null);
        	CardboardOverlayView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
					null);
        	if(position!=ImageAdapter.mps.length)
        	{position=position+1;}
            return (true);
        }
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER || keyCode == KeyEvent.KEYCODE_ENTER) {
    		...
    		case 2:
    			Intent intent1 = new Intent(MainActivity.this, MyVideoActivity.class);
    		...
    		case 5:
    			Intent intent2 = new Intent(MainActivity.this, MySettingActivity.class);
