 ...
 */
public class MyGameActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.common_uigame);
        CardboardView cardboardView = (CardboardView) findViewById(R.id.cardboard_viewgame);
        ...
        mygameView = (MyGameView) findViewById(R.id.overlaygame);
        mygameView.showlist();
...
public boolean onKeyDown(int keyCode, KeyEvent msg) {
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
        	MyGameView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
					null);
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
        	MyGameView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
					null);
        	MyGameView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
					null);
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER || keyCode == KeyEvent.KEYCODE_ENTER) {
    		...
    		case 3:
    			GetStart("com.iphodroid.DiveWorld");
    			break;

    		case 4:
    			GetStart("com.iphodroid.Rollercoaster");
    			break;

    		case 5:
    			GetStart("com.lepard.VRangrybots");
    			break;

    		case 6:
    			GetStart("com.PixelsOfEight.SGVRlogRide");
    			break;
