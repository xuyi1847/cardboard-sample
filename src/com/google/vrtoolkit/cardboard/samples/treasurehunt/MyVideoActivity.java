 ...
 */
public class MyVideoActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.common_uivideo);
        CardboardView cardboardView = (CardboardView) findViewById(R.id.cardboard_viewvideo);
        ...
        myvideoView = (MyVideoView) findViewById(R.id.overlayvideo);
        myvideoView.showlist();
        //mOverlayView.show3DToast("Welcome To The VR GameWorld");
    }
    ...
    public void onCardboardTrigger() {
        ...
        if (isLookingAtObject()) {
            mScore++;
            //myvideoView.show3DToast("Found it! Look around for another one.\nScore = " + mScore);
            hideObject();
        } else {
        	//myvideoView.show3DToast("Look around to find the object!");
        }
    ...
    private static void getGLError() {
        int error;
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent msg) {
    	        ...
    	        if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
    	        	MyVideoView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
    						null);
    	        	MyVideoView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
    						null);
    	        	if(position!=1)
    	        	{position=position-1;}
    	        ...
    	        if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
    	        	MyVideoView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
    						null);
    	        	MyVideoView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
    						null);
    	        	if(position!=ImageAdaptervideo.mps.length)
    	        	{position=position+1;}
    	            return (true);
    	        }
    	        ...
    	        if (keyCode == KeyEvent.KEYCODE_DPAD_CENTER || keyCode == KeyEvent.KEYCODE_ENTER) {
    	    		...
    	    		case 1:
		                ...
		                intent.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_airFight_0.mp4"), "video/mp4");
		                startActivity(intent);
    	    			break;

    	    		case 2:
    	    			Intent intent1 = new Intent(Intent.ACTION_VIEW);
		                intent1.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_DRAGON.mp4"), "video/mp4");
		                startActivity(intent1);
    	    			break;

    	    		case 3:
    	    			Intent intent2 = new Intent(Intent.ACTION_VIEW);
		                intent2.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_Global.mp4"), "video/mp4");
		                startActivity(intent2);
    	    			break;

    	    		case 4:
    	    			Intent intent3 = new Intent(Intent.ACTION_VIEW);
		                intent3.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_hipHop.mp4"), "video/mp4");
		                startActivity(intent3);
    	    			break;

    	    		case 5:
    	    			Intent intent4 = new Intent(Intent.ACTION_VIEW);
		                intent4.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_house.mp4"), "video/mp4");
		                startActivity(intent4);
    	    			break;
    	    		case 6:
    	    			Intent intent5 = new Intent(Intent.ACTION_VIEW);
		                intent5.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_nemo.mp4"), "video/mp4");
		                startActivity(intent5);
    	    			break;
    	    		case 7:
    	    			Intent intent6 = new Intent(Intent.ACTION_VIEW);
		                intent6.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_SEA.mp4"), "video/mp4");
		                startActivity(intent6);
    	    			break;
    	    		case 8:
    	    			Intent intent7 = new Intent(Intent.ACTION_VIEW);
		                intent7.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_superjunior.mp4"), "video/mp4");
		                startActivity(intent7);
    	    			break;
    	    		case 9:
    	    			Intent intent8 = new Intent(Intent.ACTION_VIEW);
		                intent8.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_TOPGIRL.mp4"), "video/mp4");
		                startActivity(intent8);
    	    			break;
    	    		case 10:
    	    			Intent intent9 = new Intent(Intent.ACTION_VIEW);
		                intent9.setDataAndType(Uri.parse(Environment.getExternalStorageDirectory() + "/video/video_wow.mp4"), "video/mp4");
