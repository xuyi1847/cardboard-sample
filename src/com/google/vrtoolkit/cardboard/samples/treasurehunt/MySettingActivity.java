 ...
 */
public class MySettingActivity extends CardboardActivity implements CardboardView.StereoRenderer {
    ...
    private MySettingView mysettingview;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.common_uisetting);
        CardboardView cardboardView = (CardboardView) findViewById(R.id.cardboard_viewsetting);
        ...
        mysettingview = (MySettingView) findViewById(R.id.overlaysetting);
        mysettingview.showlist();
    ...
    public void onCardboardTrigger() {
        ...
        if (isLookingAtObject()) {
            mScore++;
            //mygameView.show3DToast("Found it! Look around for another one.\nScore = " + mScore);
            hideObject();
        } else {
        	//mygameView.show3DToast("Look around to find the object!");
        }
...
public boolean onKeyDown(int keyCode, KeyEvent msg) {
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
        	MySettingView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
					null);
        	MySettingView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
					null);
        	if(position!=1)
        	{position=position-1;}
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_RIGHT) {
        	MySettingView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
					null);
        	MySettingView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_RIGHT,
					null);
        	if(position!=ImageAdaptergame.mps.length)
        	{position=position+1;}
            return (true);
        }
        if (keyCode == KeyEvent.KEYCODE_F1) {
        	MySettingView.gallery2.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
					null);
        	MyGameView.gallery.onKeyDown(KeyEvent.KEYCODE_DPAD_LEFT,
					null);
        	if(position!=1)
        	{position=position-1;}
...
//        }
        if(keyCode == KeyEvent.KEYCODE_DPAD_UP){
        	switch (position) {
    		case 1:
    			audioManager=(AudioManager)MySettingActivity.this.getSystemService(Service.AUDIO_SERVICE);
	...
	public void RegulateBrightness(int i)
	{
		stopAutoBrightness(MySettingActivity.this);
		int brightvalue = getScreenBrightness(MySettingActivity.this);
		if(i==1)
		{
			//Toast.makeText(MySettingActivity.this,"ÆÁÄ»ÁÁ¶È" + brightvalue, Toast.LENGTH_SHORT).show();
			
			int setvalue = brightvalue+25;
			if(setvalue>=250)
			{
				setBrightness(MySettingActivity.this, 250);
				saveBrightness(this.getContentResolver(), 250);
				//mysettingview.show3DToast(""+10);
			}
			
			else
			{
				setBrightness(MySettingActivity.this, setvalue);
				saveBrightness(this.getContentResolver(), setvalue);
				//mysettingview.show3DToast(""+setvalue%25);
			}
		...
		else
		{
		    ...
		    if(setvalue<=25)
			{
				setBrightness(MySettingActivity.this, 25);
				saveBrightness(this.getContentResolver(), 25);
				//mysettingview.show3DToast(""+1);
			}
		    else{
			setBrightness(MySettingActivity.this, setvalue);
			saveBrightness(this.getContentResolver(), setvalue);
