...
public class ImageAdaptersetting extends BaseAdapter {  
    private Context mContext;  
    private int selectItem;
    private LayoutInflater inflater;
    public static Integer[] mps = {  
    	R.drawable.volum, R.drawable.brightness,R.drawable.cleancache,
    	R.drawable.tuoluoyi, };
    public static String[] text = {  
        "音量控制","亮度控制","清理缓存","重制陀螺仪",
};
        public ImageAdaptersetting(Context context) {  
        	super();
        mContext = context;  
